                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Input Pendaftaran</li>
                        </ol>
                    </nav>
                </div>
                {{-- <div class="col-3">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body wizard-content">
                  <h4 class="card-title">Input Form Pendaftaran</h4>
                  <p class="card-subtitle mb-3"> Pastikan data yang diisi valid atau sesuai </p>
                  <form action="{{ url('/siswa/pendaftaran') }}/{{ $pendaftaran->id }}" class="validation-wizard wizard-circle mt-5" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Step 1 sampe email -->
                    <h6>Data Siswa</h6> 
                    <section>
