...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-2">
                        <h5 class="mb-0">Data Tata Usaha</h5>
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table border table-bordered text-nowrap align-middle">
                            ...
                            <tbody>
                                @foreach ($data_tata_usaha as $tata_usaha)
                                    <!-- start row -->
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $tata_usaha->guru->nama }}</td>
    ...
    data-bs-target="#modalHapus{{ $tata_usaha->id }}">
    Hapus
</button>


                                            <!-- Modal Konfirmasi -->
                                            <div class="modal fade" id="modalHapus{{ $tata_usaha->id }}" tabindex="-1"
                                                aria-labelledby="modalHapusLabel{{ $tata_usaha->id }}" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger text-white">
                                                            <h5 class="modal-title"
                                                                id="modalHapusLabel{{ $tata_usaha->id }}">Konfirmasi Hapus
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <b>{{ $tata_usaha->guru->nama }}</b>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal">Batal</button>

                                                            <form action="{{ url('/admin/delete_tata_usaha/' . $tata_usaha->id) }}"
...
<div class="modal fade" id="modal-tambah-guru" tabindex="-1" aria-labelledby="mySmallModalLabel" style="display: none;"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/store_tata_usaha') }}" method="post">
                @csrf
                <div class="modal-body">
